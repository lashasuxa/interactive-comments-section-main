...
const createCommentCard = (element, isReply, currentUsername) => {
  ...
  //
  // ...
  plusButton.addEventListener("click", (event) => updateScore(event, true));
  minusButton.addEventListener("click", (event) => updateScore(event, false));
  // ...
  //

  if (isReply && element.user.username === currentUsername) {
