...
const initMyComments = () => {
  const myCommentsContainer = document.querySelector(".my_comments_container");
  data.currentUser.forEach((currentUser) => {
    const myCommentContainer = createCommentContainer(currentUser);
...
let parent = document.querySelector(".card_container");
